<x-layouts.app title="Calendar 25">
        ...
        <div class="flex flex-col gap-6">
            ...
            >
                ...
                <button
                    ...
                    x-ref="trigger"
                    @click="open = !open"
                    class="border-input dark:bg-input/30 dark:hover:bg-input/50 inline-flex h-9 w-full items-center justify-between gap-2 rounded-md border bg-background px-3 py-2 text-left text-sm font-normal whitespace-nowrap shadow-xs transition-[color,box-shadow] outline-none hover:bg-accent hover:text-accent-foreground focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]"
                >
            ...
            <div class="flex gap-4">
                <div class="flex flex-col gap-3">
                    <x-ui.label for="time-from" class="px-1">From</x-ui.label>
                    <x-ui.input
                        type="time"
                        id="time-from"
                        step="1"
                ...
                <div class="flex flex-col gap-3">
                    <x-ui.label for="time-to" class="px-1">To</x-ui.label>
                    <x-ui.input
                        type="time"
                        id="time-to"
                        step="1"
